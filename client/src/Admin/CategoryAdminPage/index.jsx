                                    ...
                                    return (
                                        <tr key={index} className='hover:bg-gray-100'>
                                            ...
                                            <td className='p-4 space-x-2'>
                                                <button onClick={() => { handleShowEditForm(item?.category_id) }} className='inline-flex items-center py-2 px-3 text-sm font-medium text-center text-gray-700 bg-gray-200 rounded-lg hover:bg-gray-300 hover:text-gray-900 hover:scale-[1.02] transition-all'>Edit</button>

                                                <button onClick={() => { handleShowDeleteForm(item?.category_id) }} className='inline-flex items-center py-2 px-3 text-sm font-medium text-center bg-main text-white rounded-lg hover:scale-[1.02] transition-transform'>Delete</button>
                                            </td>
                                        </tr>
                                    )
                                })}
