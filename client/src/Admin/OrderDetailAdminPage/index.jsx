...
const OrderDetailAdminPage = () => {
    ...
    const products = data?.order_details
                ...
                <div className="col-span-2 bg-white rounded-lg shadow-md p-5">
                    <div className="flex justify-between items-center">
                        <span className='text-[24px] font-semibold text-main'>
                            ...
                            <span className=' uppercase'>({data?.payment_info?.payment_method})</span>
                        </span>
                        <span className='flex items-center gap-x-3'>
                            <Status status={data?.status} />
                        </span>
                    </div>
                    <span className='text-gray-500 text-sm font-medium' >Ngày đặt: {helpers.dateFormat(data?.order_date)}</span>
                    ...
                    <div className="my-5 text-end text-[20px] font-bold text-gray-800">
                        <h1>Tổng hóa đơn: {helpers.numberFormat(data?.total_amount)}đ</h1>
                    </div>
                </div>
                    ...
                    <div className="mt-4">
                        ...
                        <div className="flex mt-[40px] items-start">
                            ...
                            <div className="flex flex-col ml-3">
                                ...
                                <span>(+84) {data?.phone_number.slice(1)}</span>
                            </div>
                        </div>
                    </div>
                </div>
