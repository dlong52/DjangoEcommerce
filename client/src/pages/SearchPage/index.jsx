...
const SearchPage = () => {
    ...
    const queryProducts = useQuery({
        queryKey: ['products', { name: searchName, category: selectedCategory, collection: selectedCollection, size: selectedSize, min_price: minPriceState, max_price: maxPriceState, order_by: orderByState, page: selectedPage, page_size: page_size, status: true }],
    ...
    const categories = queryCategories?.data?.results;
    const collections = queryCollections?.data?.results;
                ...
                <div className="flex flex-col md:flex-row md:items-center">
                    ...
                    >
                        ...
                        {collections?.map((coll) => (
                            <option key={coll.id} value={coll.collection_id}>{coll.name}</option>
                        ))}
                    </select>
                </div>
            </div>
