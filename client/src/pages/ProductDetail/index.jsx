    ...
    const handleAddToCart = async () => {
        ...
        try {
            ...
            if (productDetail?.stock_quantity > 0) {
                const res = await addToCart(p_id, quantity, selectedSize, user.user_id);
                ...
                <div className="grid grid-cols-12 gap-x-6">
                    <div className="col-span-6 grid grid-cols-12">
                        ...
                        <div className="col-span-10">
                            <img className='w-full rounded-[10px]' src={productDetail?.images[imgActive]} alt="" />
                        </div>
                    </div>
                        ...
                        <div className="flex flex-col gap-y-3">
                            ...
                            <div className="mt-4 flex items-center gap-3">
                                <button
                                    ...
                                    className={`text-white font-medium px-6 h-[45px] rounded-full flex-1 duration-200 flex items-center justify-center ${productDetail?.stock_quantity === 0 ? 'bg-gray-600 ' : 'bg-main hover:bg-[#d9d9d9] hover:text-black'}`}
                                >
                                    {loading && <LayzyLoad />}
                                    {!loading && productDetail?.stock_quantity > 0 && "Thêm vào giỏ hàng"}
                                    {!loading && productDetail?.stock_quantity === 0 && "Sản phẩm đã hết hàng"}
                                </button>
