    ...
    return (
        <div className="bg-white shadow-xl rounded-lg p-10">
            ...
            <div className="flex justify-between items-center pb-6 border-b mb-6">
                ...
                <span className="text-gray-500 text-sm">Yêu cầu vào: {helpers.dateFormat(data?.order_date)}</span>
            </div>
                ...
                {data?.order_details?.map((item, index) => (
                    <div className="flex justify-between items-start border-b pb-4" key={index}>
                        <div className="flex gap-5 items-center">
                            <img className="w-28 h-28 object-cover rounded-lg shadow-md transition-transform duration-200 hover:scale-105" src={item?.image} alt={item?.product_name} />
            ...
            <div className="flex justify-between items-center mt-10 border-t pt-4">
                ...
                <span className="text-2xl font-bold text-gray-800">
                    {helpers.numberFormat(data?.total_amount)} VND
                </span>
            </div>
